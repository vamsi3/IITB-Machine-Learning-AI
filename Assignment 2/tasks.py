...
def taskSquare(draw):
	...
	nn1 = nn.NeuralNetwork(2, 0.08, 64, 50)
...
def taskSemiCircle(draw):
	...
	nn1 = nn.NeuralNetwork(2, 0.05, 64, 50)
...
def taskMnist():
	...
	nn1 = nn.NeuralNetwork(10, 0.01, 32, 40)
...
def taskCifar10():	
	...
	nn1 = nn.NeuralNetwork(10, 0.01, 64, 40)
	nn1.addLayer(ConvolutionLayer((3, 32, 32), (11, 11), 4, 7))
	nn1.addLayer(FlattenLayer())
	nn1.addLayer(FullyConnectedLayer(64, 10))
